...
namespace GameOfLife {
	const short Board::validRow(const short index) const {
	...
	const short Board::validColumn(const short index) const {
	...
	const bool Board::isAlive(unsigned short row, unsigned short column) const {
